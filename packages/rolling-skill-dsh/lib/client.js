...
var zh = {
  ...
  optimizationBoundary: "\u95ED\u73AF\u8FB9\u754C",
  optimizationMaxEpochs: "\u6700\u5927\u95ED\u73AF\u6B21\u6570\uFF08Epoch\uFF09",
  optimizationActivation: "Skill \u89E6\u53D1\u65B9\u5F0F",
  optimizationAutomaticActivation: "\u81EA\u52A8\u89E6\u53D1\uFF08\u6309\u771F\u5B9E\u4F7F\u7528\u9A8C\u8BC1\uFF09",
  optimizationExplicitActivation: "\u663E\u5F0F\u6307\u5B9A Skill",
  optimizationBoundaryHelp: "\u4E00\u4E2A Epoch \u5305\u62EC\u6539\u8FDB Skill\u3001\u5B89\u88C5\u5019\u9009\u7248\u672C\u3001\u5B8C\u6574\u8BC4\u6D4B\u548C\u7ED3\u679C\u590D\u76D8\uFF1BEpoch \u5185 Agent \u64CD\u4F5C\u4E0D\u9650\u6B21\u3002",
  optimizationInvalidLimits: "\u6700\u5927\u95ED\u73AF\u6B21\u6570\u5FC5\u987B\u662F 1\u2013100 \u7684\u6574\u6570\u3002",
  retry: "\u91CD\u8BD5",
  ...
  optimizationDirection: "\u4F18\u5316\u65B9\u5411\uFF08\u53EF\u9009\uFF09",
  optimizationSampledSearch: "\u968F\u673A\u53CD\u9988\u591A\u5019\u9009\u641C\u7D22",
  optimizationCandidatesPerRound: "\u6BCF\u7EC4\u5019\u9009\u6570",
  optimizationFailureSamples: "\u6BCF\u5019\u9009\u5931\u8D25\u6837\u672C\u6570",
  optimizationCaseWorkers: "\u6BCF Runtime \u5E76\u53D1 Case \u6570",
  optimizationSampledSearchHelp: "\u6700\u5927 Epoch \u662F\u5019\u9009\u603B\u9884\u7B97\u3002\u5E76\u53D1\u9ED8\u8BA4\u5173\u95ED\uFF1B\u542F\u7528\u524D\u786E\u8BA4\u4E1A\u52A1\u6570\u636E\u9694\u79BB\u53CA Skill \u5728\u5B50\u76EE\u5F55\u4E2D\u7684\u81EA\u52A8\u53D1\u73B0\u3002",
  optimizationDirectionPlaceholder: "\u4F8B\u5982\uFF1A\u91CD\u70B9\u6539\u5584\u6743\u9650\u67E5\u8BE2\u3001\u5F02\u5E38\u4E0B\u94BB\u548C\u5931\u8D25\u540E\u7684\u6062\u590D\u4F53\u9A8C\u3002\u7559\u7A7A\u65F6\u7531\u7CFB\u7EDF\u5168\u9762\u4F18\u5316\u3002",
  optimizationDirectionHelp: "\u7559\u7A7A\u65F6\uFF0C\u7CFB\u7EDF\u6839\u636E\u57FA\u7EBF\u8BC4\u6D4B\u548C\u7528\u6237\u4F7F\u7528\u4F53\u9A8C\u81EA\u4E3B\u5BFB\u627E\u6539\u8FDB\u70B9\uFF1B\u586B\u5199\u540E\u4F18\u5148\u5904\u7406\u8BE5\u65B9\u5411\u3002",
  optimizationSystemDirection: "\u7CFB\u7EDF\u5168\u9762\u4F18\u5316",
  optimizationFrozenConfiguration: "\u672C\u6B21\u51BB\u7ED3\u914D\u7F6E",
...
var en = {
  ...
  optimizationBoundary: "Closed-loop boundary",
  optimizationMaxEpochs: "Maximum closed-loop count (Epoch)",
  ...
  optimizationBoundaryHelp: "One Epoch improves the Skill, installs the candidate, runs the full evaluation, and reviews the result. Agent actions within an Epoch are not limited.",
  optimizationInvalidLimits: "Maximum closed-loop count must be an integer from 1 to 100.",
  retry: "Retry",
  ...
  optimizationDirection: "Optimization direction (optional)",
  optimizationSampledSearch: "Sampled candidate search",
  optimizationCandidatesPerRound: "Candidates per round",
  optimizationFailureSamples: "Failure samples per candidate",
  optimizationCaseWorkers: "Case workers per Runtime",
  optimizationSampledSearchHelp: "Maximum Epochs is the total candidate budget. Concurrency is opt-in: verify business-state isolation and Skill discovery from Case subdirectories.",
  optimizationDirectionPlaceholder: "For example: prioritize permission queries, anomaly drilldown, and recovery after failures. Leave blank for comprehensive system optimization.",
  optimizationDirectionHelp: "When blank, the system finds improvements from baseline evaluations and the user experience; when filled, it prioritizes this direction.",
  optimizationSystemDirection: "Comprehensive system optimization",
  optimizationFrozenConfiguration: "Frozen configuration",
...
function OptimizationStoppingFields({ value, onChange, t }) {
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("fieldset", { className: "rolling-skill-subpanel", children: [
    /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("legend", { children: t("optimizationBoundary") }),
    /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "rolling-skill-grid", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("label", { className: "rolling-skill-field", children: [
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { children: t("optimizationMaxEpochs") }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("input", { className: "rolling-skill-select", type: "number", min: 1, max: 100, step: 1, value: value.maxEpochs, onChange: (event) => onChange({ ...value, maxEpochs: event.target.value }) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("label", { className: "rolling-skill-field", children: [
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { children: t("optimizationSampledSearch") }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("input", { type: "checkbox", checked: value.sampledSearch ?? false, onChange: (event) => onChange({ ...value, sampledSearch: event.target.checked }) })
      ] }),
      value.sampledSearch ? /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("label", { className: "rolling-skill-field", children: [
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { children: t("optimizationCandidatesPerRound") }),
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("input", { type: "number", min: 1, max: 8, value: value.candidatesPerRound ?? "3", onChange: (event) => onChange({ ...value, candidatesPerRound: event.target.value }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("label", { className: "rolling-skill-field", children: [
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { children: t("optimizationFailureSamples") }),
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("input", { type: "number", min: 1, max: 24, value: value.failureSamples ?? "6", onChange: (event) => onChange({ ...value, failureSamples: event.target.value }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("label", { className: "rolling-skill-field", children: [
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { children: t("optimizationCaseWorkers") }),
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("input", { type: "number", min: 1, max: 8, value: value.caseWorkers ?? "1", onChange: (event) => onChange({ ...value, caseWorkers: event.target.value }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("p", { className: "rolling-skill-help", children: t("optimizationSampledSearchHelp") })
      ] }) : null
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("p", { className: "rolling-skill-help", children: t("optimizationBoundaryHelp") })
  ] });
}
function optimizationNumericLimits(value) {
  ...
  const search2 = value.sampledSearch ? {
  ...
  if (search2 && Object.entries(search2).some(([key, number2]) => !Number.isInteger(number2) || number2 < 1 || number2 > (key === "failureSamples" ? 24 : 8))) throw new Error("optimizationInvalidLimits");
  return { limits: { maxEpochs }, ...search2 ? { search: search2 } : {} };
}
...
function OptimizationPanel({ t, initialRunId, onNavigate }) {
  ...
  const [optimizationDirection, setOptimizationDirection] = (0, import_react16.useState)("");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("section", { className: "rolling-skill-panel", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("label", { className: "rolling-skill-field rolling-skill-optimization-direction", children: [
      /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("span", { children: t("optimizationDirection") }),
      /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("textarea", { className: "rolling-skill-textarea", maxLength: 8e3, value: optimizationDirection, placeholder: t("optimizationDirectionPlaceholder"), onChange: (event) => setOptimizationDirection(event.target.value) }),
      /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("small", { className: "rolling-skill-help", children: t("optimizationDirectionHelp") })
    ] }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("div", { className: "rolling-skill-actions", children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(ActionButton, { disabled: busy || !ready, onClick: () => void start2(), children: t("startOptimization") }) }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(import_dsh_client_ui_primitives8.Modal, { open: runDetail !== null, onClose: () => setRunDetail(null), title: t("optimizationDetail"), closeLabel: t("close"), footer: /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, { children: [
      ...
      pollError ? /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("p", { className: "rolling-skill-inline-error", role: "alert", children: pollError }) : null,
      runDetail.playbook ? /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("section", { className: "rolling-skill-subpanel", children: [
        /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("h4", { children: t("optimizationFrozenConfiguration") }),
        /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("p", { children: [
          t("optimizationDirection"),
          ": ",
          runDetail.optimizationDirection || t("optimizationSystemDirection")
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("p", { children: [
          t("optimizationMethod"),
          ": ",
          `Rolling Skill Optimization Playbook v${runDetail.playbook.version} \xB7 ${runDetail.playbook.digest.slice(0, 19)}\u2026`
        ] })
      ] }) : null,
