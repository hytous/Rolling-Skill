...
- [ ] **Step 3: Add latest-target scope revalidation**
...
- [ ] **Step 4: Verify GREEN and the real missing-Rubric guard**
...
- [ ] **Step 1: Write failing state and startup-cleanup tests**
...
- [ ] **Step 3: Implement minimal error lifecycle methods**
...
- [ ] **Step 3: Implement narrow setting detection and startup cleanup**
...
- [ ] **Step 2: Package, sign, and install**
...
- [ ] **Step 3: Verify the user-visible regression**
