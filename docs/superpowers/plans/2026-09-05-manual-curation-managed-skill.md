...
- [x] **Step 1: Write failing bridge assertions**
...
- [x] **Step 2: Run the focused bridge test and verify RED**
...
- [x] **Step 3: Wire the managed resolver**
...
- [x] **Step 4: Run the focused bridge and curation tests**
...
- [x] **Step 2: Run the Renderer contract tests and verify RED**
...
- [x] **Step 3: Implement managed selectors and automatic display**
...
- [x] **Step 4: Implement explicit start feedback and localized blockers**
...
- [x] **Step 1: Add a failing renderer smoke scenario**
...
- [x] **Step 2: Run smoke and verify RED, then update fixture wiring**
...
- [x] **Step 4: Build, install, and replay the real workflow**
