...
const translations = {
    en: {
        ...
        operatorManageJobs: "Manage",
        operatorSelectAllFinished: "Select finished",
        operatorCancelManagement: "Cancel",
        operatorDeleteSelectedCount: "Delete selected ({count})",
        operatorDeleteRecordsConfirm: "Remove {count} finished task records from this list? Optimization reports and audit evidence will be kept.",
        operatorSelectJobRecord: "Select {title}",
        operatorFinishBeforeDelete: "Stop this task before deleting its record",
        ...
        operatorOptimizationDirection: "Optimization direction · optional",
        operatorOptimizationDirectionPlaceholder: "For example: prioritize permission queries, anomaly drilldown, and recovery after failures. Leave blank for comprehensive system optimization.",
        operatorOptimizationDirectionHelp: "When blank, the system finds improvements from baseline evaluations and the user experience; when filled, it prioritizes this direction.",
        ...
        operatorManagedSkill: "Managed Skill",
        ...
        operatorOptimizationProgress: "Optimization progress",
        operatorOptimizationFlow: "Optimization flow",
        operatorFlowPrepare: "Prepare",
        operatorFlowBaseline: "Baseline evaluation",
        operatorFlowEpoch: "Epoch {value}",
        operatorFlowEdit: "Improve Skill",
        operatorFlowInstall: "Install candidate",
        operatorFlowEvaluate: "Complete evaluation",
        operatorFlowDecide: "Review and decide",
        operatorFlowApproval: "Final approval",
        operatorFlowRelease: "Publish and install improved version",
        operatorFlowRestore: "Restore original version when needed",
        operatorFlowFinish: "Finish",
        operatorFlowStatusCompleted: "Completed",
        operatorFlowStatusActive: "In progress",
        operatorFlowStatusFailed: "Needs attention",
        operatorFlowStatusCancelled: "Stopped",
        operatorFlowStatusPending: "Not started",
        operatorFlowOpenEvaluation: "View this evaluation",
        operatorOptimizationPhasePreflight: "Preparing optimization",
        operatorOptimizationPhaseBaseline: "Running baseline evaluation",
        operatorOptimizationPhaseEditing: "Improving the Skill",
        operatorOptimizationPhaseInstalling: "Installing the candidate",
        operatorOptimizationPhaseEvaluating: "Running the complete evaluation",
        operatorOptimizationPhaseDeciding: "Reviewing evaluation results",
        operatorOptimizationPhaseWaitingApproval: "Waiting for your decision",
        operatorOptimizationPhaseRestoring: "Restoring the original version",
        operatorOptimizationPhasePaused: "Optimization paused",
        operatorOptimizationPhaseSucceeded: "Optimization complete",
        operatorOptimizationPhaseFailed: "Optimization failed",
        operatorOptimizationPhaseCancelled: "Optimization cancelled",
        operatorOptimizationPhaseNeedsRecovery: "Recovery needs attention",
        operatorOptimizationCopyPreflight: "Checking the frozen inputs and Runtime readiness.",
        operatorOptimizationCopyBaseline: "Establishing the starting result for comparison.",
        operatorOptimizationCopyEditing: "The Agent is improving the Skill using evaluation evidence.",
        operatorOptimizationCopyInstalling: "Installing the candidate temporarily on the selected Runtimes.",
        operatorOptimizationCopyEvaluating: "Testing the candidate from end to end against the frozen Dataset.",
        operatorOptimizationCopyDeciding: "Comparing this Epoch with the baseline and prior results.",
        operatorOptimizationCopyWaitingApproval: "The final result is ready. Choose whether to install it.",
        operatorOptimizationCopyRestoring: "Restoring the selected Runtimes to the original Skill version.",
        operatorOptimizationCopyPaused: "Progress is saved. Resume when you are ready.",
        operatorOptimizationCopySucceeded: "The optimization is complete. You can review the report.",
        operatorOptimizationCopyFailed: "The optimization did not finish. Review the report for details.",
        operatorOptimizationCopyCancelled: "The task stopped. Review the report for completed work.",
        operatorOptimizationCopyNeedsRecovery: "One or more Runtime Skills could not be confirmed as restored.",
        operatorEpochProgress: "Epoch {current}/{max}",
        operatorEpochNotStarted: "Epoch not started",
        operatorDirectionSummary: "Priority: {value}",
        operatorLatestResult: "Latest evaluation",
        operatorEpochResult: "Epoch {value}",
        operatorCurrentScore: "Current score",
        operatorBaselineScore: "Baseline score",
        operatorPassRate: "Pass rate",
        operatorRegressionCount: "Regressions",
        operatorComparedWithBaseline: "vs baseline {value}",
        operatorNoEvaluationResult: "Results will appear after the first complete evaluation.",
        operatorDecisionRequired: "Your decision is needed",
        operatorFinalDecisionHelp: "The complete evaluation is ready. Install the improved version or restore the original version.",
        operatorAffectedRuntimes: "{count} Runtimes: {value}",
        operatorRecoveryRequired: "Recovery needs attention",
        operatorRecoveryHelp: "Some Runtime Skills could not be confirmed as restored. Open the affected installation below.",
        operatorTechnicalDetails: "Technical details",
        operatorFrozenInputs: "Frozen inputs",
        operatorEpochHistory: "Epoch evaluation history",
        operatorInstallationDetails: "Runtime installations",
        operatorInternalState: "Internal state",
        ...
        operatorNoModels: "No available models",
        ...
        operatorOptimizationDirectionValue: "Direction {value}",
        operatorOptimizationMethodValue: "Method {value}",
        operatorSystemOptimization: "comprehensive system optimization",
        ...
        operatorErrorOptimizationBaselineInstallation: "Runtime {runtime} does not have the selected baseline installed and verified. Install it from Skill Installations before starting Optimization.",
        ...
        installWithRuntimes: "Install on selected runtimes",
    ...
    "zh-CN": {
        ...
        operatorJobs: "任务",
        operatorNewJob: "新建任务",
        operatorManageJobs: "管理",
        operatorSelectAllFinished: "全选已结束",
        operatorCancelManagement: "取消",
        operatorDeleteSelectedCount: "删除所选（{count}）",
        operatorDeleteRecordsConfirm: "从任务列表移除所选的 {count} 条已结束记录？优化报告和审计证据会继续保留。",
        operatorSelectJobRecord: "选择任务：{title}",
        operatorFinishBeforeDelete: "请先停止任务，再删除记录",
        ...
        operatorOptimizationDirection: "优化方向（可选）",
        operatorOptimizationDirectionPlaceholder: "例如：重点改善权限查询、异常下钻和失败后的恢复体验。留空时由系统全面优化。",
        operatorOptimizationDirectionHelp: "留空时，系统根据基线评测和用户使用体验自主寻找改进点；填写后优先处理该方向。",
        operatorRuntime: "操作 Runtime",
        operatorManagedSkillOptional: "受管 Skill · 可选",
        operatorDatasetOptional: "数据集 · 可选",
        operatorManagedSkill: "受管 Skill",
        operatorDataset: "数据集",
        ...
        operatorOptimizationProgress: "优化进度",
        operatorOptimizationFlow: "自动优化流程",
        operatorFlowPrepare: "准备",
        operatorFlowBaseline: "基线评测",
        operatorFlowEpoch: "第 {value} 个 Epoch",
        operatorFlowEdit: "改进 Skill",
        operatorFlowInstall: "安装候选版本",
        operatorFlowEvaluate: "完整评测",
        operatorFlowDecide: "复盘并决定下一步",
        operatorFlowApproval: "最终审批",
        operatorFlowRelease: "发布并安装改进版",
        operatorFlowRestore: "必要时恢复原版本",
        operatorFlowFinish: "完成",
        operatorFlowStatusCompleted: "已完成",
        operatorFlowStatusActive: "进行中",
        operatorFlowStatusFailed: "需要处理",
        operatorFlowStatusCancelled: "已停止",
        operatorFlowStatusPending: "尚未开始",
        operatorFlowOpenEvaluation: "查看本次评测",
        operatorOptimizationPhasePreflight: "正在准备优化",
        operatorOptimizationPhaseBaseline: "正在运行基线评测",
        operatorOptimizationPhaseEditing: "正在改进 Skill",
        operatorOptimizationPhaseInstalling: "正在安装候选版本",
        operatorOptimizationPhaseEvaluating: "正在运行完整评测",
        operatorOptimizationPhaseDeciding: "正在分析评测结果",
        operatorOptimizationPhaseWaitingApproval: "等待你的决定",
        operatorOptimizationPhaseRestoring: "正在恢复原版本",
        operatorOptimizationPhasePaused: "优化已暂停",
        operatorOptimizationPhaseSucceeded: "优化已完成",
        operatorOptimizationPhaseFailed: "优化失败",
        operatorOptimizationPhaseCancelled: "优化已取消",
        operatorOptimizationPhaseNeedsRecovery: "恢复需要处理",
        operatorOptimizationCopyPreflight: "正在检查冻结输入和 Runtime 是否就绪。",
        operatorOptimizationCopyBaseline: "正在建立可用于前后对比的起始结果。",
        operatorOptimizationCopyEditing: "Agent 正在根据评测证据改进 Skill。",
        operatorOptimizationCopyInstalling: "正在把候选版本临时安装到所选 Runtime。",
        operatorOptimizationCopyEvaluating: "正在使用冻结数据集对候选版本做端到端测试。",
        operatorOptimizationCopyDeciding: "正在与基线和之前轮次对比，判断是否继续。",
        operatorOptimizationCopyWaitingApproval: "最终结果已准备好，请决定是否安装。",
        operatorOptimizationCopyRestoring: "正在把所选 Runtime 恢复到原 Skill 版本。",
        operatorOptimizationCopyPaused: "进度已经保存，可随时继续。",
        operatorOptimizationCopySucceeded: "优化已经完成，可以查看报告。",
        operatorOptimizationCopyFailed: "优化未完成，请查看报告了解详情。",
        operatorOptimizationCopyCancelled: "任务已经停止，可查看报告了解已完成的工作。",
        operatorOptimizationCopyNeedsRecovery: "一个或多个 Runtime 尚未确认恢复原版本。",
        operatorEpochProgress: "Epoch {current}/{max}",
        operatorEpochNotStarted: "Epoch 尚未开始",
        operatorDirectionSummary: "优先方向：{value}",
        operatorLatestResult: "最近评测",
        operatorEpochResult: "第 {value} 个 Epoch",
        operatorCurrentScore: "当前得分",
        operatorBaselineScore: "基线得分",
        operatorPassRate: "通过率",
        operatorRegressionCount: "退步项",
        operatorComparedWithBaseline: "较基线 {value}",
        operatorNoEvaluationResult: "完成首轮完整评测后，这里会显示结果。",
        operatorDecisionRequired: "需要你的决定",
        operatorFinalDecisionHelp: "完整评测已经结束，请选择安装改进版或恢复原版本。",
        operatorAffectedRuntimes: "影响 {count} 个 Runtime：{value}",
        operatorRecoveryRequired: "恢复需要处理",
        operatorRecoveryHelp: "部分 Runtime 尚未确认恢复原版本，请打开下方对应安装记录处理。",
        operatorTechnicalDetails: "技术详情",
        operatorFrozenInputs: "冻结输入",
        operatorEpochHistory: "各轮评测",
        operatorInstallationDetails: "Runtime 安装记录",
        operatorInternalState: "内部状态",
        ...
        operatorOptimizationDirectionValue: "优化方向 {value}",
        operatorOptimizationMethodValue: "优化方法 {value}",
        operatorSystemOptimization: "系统全面优化",
        ...
        installWithRuntimes: "安装到所选 Runtime",
