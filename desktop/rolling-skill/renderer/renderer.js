...
const translations = {
    en: {
        ...
        operatorPreflightApprovals: "The first Candidate experiment install and one final release-and-install decision still require explicit approval.",
    ...
    "zh-CN": {
        ...
        operatorPreflightApprovals: "首次安装实验改进版，以及最终一次“发布并安装”决定，仍需明确审批。",
