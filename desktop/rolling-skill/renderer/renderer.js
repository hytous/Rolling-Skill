...
const translations = {
    en: {
        ...
        operatorWorkbenchHelp: "Configure Runtime, scope, and hard budgets for durable local Agent work.",
        operatorJobs: "Jobs",
        operatorNewJob: "New Job",
        operatorScopedSession: "Scoped session",
        operatorStartSelfOperation: "Start self-operation",
        operatorStartHelp: "Choose the Runtime, authority, scope, and hard budget for this durable Job.",
        ...
        operatorEpochMode: "Epoch mode",
        operatorAdaptive: "Adaptive",
        operatorFixed: "Fixed",
        operatorStoppingRules: "Stopping rules and hard limits",
        operatorMaxEpochs: "Max Epochs",
        operatorPatience: "Patience",
        operatorMinimumImprovement: "Minimum improvement",
        operatorDurationMs: "Duration (ms)",
        operatorTurns: "Operator turns",
        operatorTokensTelemetry: "Tokens · telemetry required",
        operatorCostTelemetry: "Cost micros · telemetry required",
        operatorTargetScore: "Target score",
        operatorTargetPassRate: "Target pass rate",
        operatorRequireCriticalCases: "Require critical Cases",
        operatorPreflightInitial: "Run preflight to freeze inputs and inspect installation readiness.",
        operatorPermissionsBudget: "Permission grants and budget",
        operatorPermissionGrants: "Permission grants",
        operatorHardBudget: "Hard budget",
        ...
        operatorRunPreflight: "Run Optimization preflight",
        ...
        operatorConfigurationChanged: "Configuration changed. Run preflight again before starting.",
        operatorPreflightFrozen: "Frozen {version} ({digest})",
        operatorPreflightDataset: "Dataset {id} @ revision {revision}",
        operatorPreflightRubric: "Rubric {id} @ version {version}",
        operatorPreflightTargets: "{count} target Runtime(s)",
        operatorPreflightTelemetry: "Telemetry: tokens {tokens}, cost {cost}",
        operatorPreflightApprovals: "Approvals remain explicit for the first Candidate experiment install, release, and Released install.",
        operatorCheckingPreflight: "Checking frozen inputs and Runtime readiness…",
        operatorPreflightFailed: "Preflight failed. Fix the configuration and retry.",
        operatorPreflightRequired: "Run Optimization preflight for the current configuration before Start.",
        operatorYes: "yes",
        operatorNo: "no",
        operatorDigestPending: "digest pending",
        ...
        operatorRemainingDuration: "Remaining duration {value}",
        operatorRemainingTurns: "turns {value}",
        operatorRemainingTokens: "tokens {value}",
        operatorRemainingCost: "cost µ {value}",
        operatorStopReason: "Stop reason {value}",
        operatorReleaseApproval: "Release approval {value}",
        operatorReleasedValue: "Released {value}",
        operatorFinalRegression: "Final regression {value}",
    ...
    "zh-CN": {
        ...
        operatorWorkbenchHelp: "为本地 Agent 配置 Runtime、作用范围与硬预算，并持续管理任务。",
        operatorJobs: "任务",
        operatorNewJob: "新建任务",
        operatorScopedSession: "受限会话",
        operatorStartSelfOperation: "新建自操作任务",
        operatorStartHelp: "选择 Runtime、权限、作用范围和硬预算；任务会持久保存。",
        ...
        operatorEpochMode: "迭代模式",
        operatorAdaptive: "自适应",
        operatorFixed: "固定轮数",
        operatorStoppingRules: "停止条件与硬上限",
        operatorMaxEpochs: "最大轮数",
        operatorPatience: "无提升容忍轮数",
        operatorMinimumImprovement: "最小有效提升",
        operatorDurationMs: "最长时间（毫秒）",
        operatorTurns: "操作 Agent 轮次",
        operatorTokensTelemetry: "Token 上限 · 需要遥测",
        operatorCostTelemetry: "成本上限（微单位）· 需要遥测",
        operatorTargetScore: "目标分数",
        operatorTargetPassRate: "目标通过率",
        operatorRequireCriticalCases: "关键 Case 必须通过",
        operatorPreflightInitial: "先执行预检，冻结输入并检查安装条件。",
        operatorPermissionsBudget: "权限与预算",
        operatorPermissionGrants: "允许的操作",
        operatorHardBudget: "硬预算",
        ...
        operatorConfigurationChanged: "配置已变化，请重新预检后再开始。",
        operatorPreflightFrozen: "已冻结 {version}（{digest}）",
        operatorPreflightDataset: "数据集 {id} · 修订 {revision}",
        operatorPreflightRubric: "评分标准 {id} · 版本 {version}",
        operatorPreflightTargets: "{count} 个目标 Runtime",
        operatorPreflightTelemetry: "遥测：Token {tokens}，成本 {cost}",
        operatorPreflightApprovals: "首次安装实验 Candidate、发布版本和安装 Released 版本仍需明确审批。",
        operatorCheckingPreflight: "正在检查冻结输入和 Runtime 就绪状态…",
        operatorPreflightFailed: "预检失败，请修正配置后重试。",
        operatorPreflightRequired: "请先对当前配置执行优化预检，再开始任务。",
        operatorYes: "支持",
        operatorNo: "不支持",
        operatorDigestPending: "摘要待生成",
        ...
        operatorRemainingDuration: "剩余时间 {value}",
        operatorRemainingTurns: "剩余轮次 {value}",
        operatorRemainingTokens: "剩余 Token {value}",
        operatorRemainingCost: "剩余成本（微单位）{value}",
        operatorStopReason: "停止原因 {value}",
        operatorReleaseApproval: "发布审批 {value}",
        operatorReleasedValue: "已发布版本 {value}",
        operatorFinalRegression: "最终回归 {value}",
