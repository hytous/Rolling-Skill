...
const translations = {
    en: {
        ...
        operatorWorkbenchHelp: "Configure Runtime, scope, and an iteration boundary for durable local Agent work.",
        operatorJobs: "Jobs",
        operatorNewJob: "New Job",
        operatorScopedSession: "Scoped session",
        operatorStartSelfOperation: "Start self-operation",
        operatorStartHelp: "Choose the Runtime, scope, and automation boundary for this durable Job.",
    ...
    "zh-CN": {
        ...
        operatorWorkbenchHelp: "为本地 Agent 配置 Runtime、作用范围与迭代边界，并持续管理任务。",
        operatorJobs: "任务",
        operatorNewJob: "新建任务",
        operatorScopedSession: "受限会话",
        operatorStartSelfOperation: "新建自操作任务",
        operatorStartHelp: "选择 Runtime、作用范围和自动化边界；任务会持久保存。",
